...
## 4. Linking the issue with a repository

Issues being submitted must be linked to a repository to align it with the source of the issue. This is done through the use of labels:

| Label                       | Description                                                                                                                                                          |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `karavi-observability`      | The source of the issue is the karavi-observability repository. Issues associated with this repository will likely be documentation specific since there is no code. |
| `karavi-topology`           | The source of the issue is the karavi-topology repository.                                                                                                           |
| `karavi-metrics-powerflex` | The source of the issue is the karavi-metrics-powerflex repository.                                                                                                  |

Pull requests created in other repositories must link to an issue in the karavi-observability repository.
