...
create_bundle() {
    ...
    run_command "curl -o ${DISTDIR}/${HELMBACKUPDIR}/cert-manager.crds.yaml -L https://github.com/jetstack/cert-manager/releases/download/v1.10.0/cert-manager.crds.yaml"
